---
name: graph-handover
description: Update dependency_graph.json (current_node, wip_status, edges), propose splits and folds, run the staleness check, and write the lossless WIP handover at config.handover_path. Delegates to the graph-context-sync protocol.
---
...
2. Execute the section titled `/graph-handover` exactly as written there, with the arguments given to this
...
Equivalent invocation: `/graph-context-sync handover <args>`.
